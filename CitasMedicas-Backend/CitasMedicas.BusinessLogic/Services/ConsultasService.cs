    ...
    public class ConsultasService
    {
        ...
        public ServiceResult ConsultaInsertar(int citaId, int medicoIdLogueado, ConsultaDTO consulta)
        {
            ...
            try
            {
                ...
                var response = _consultasRepository.ConsultaInsertar(citaId, consulta);
        ...
        //
        //         var response = _consultasRepository.ConsultaActualizar(citaId, consulta);
        //         return MapRequestStatusToServiceResult(response);
        //     }
        //     catch (Exception ex)
        //     {
        ...
        //     try
        //     {
        //         var consulta = _consultasRepository.ConsultaObtenerPorCita(citaId);
        //         if (consulta == null)
        ...
        //     try
        //     {
        //         var historial = _consultasRepository.HistorialObtenerPorPaciente(pacienteId);
